                  ...
                  SlidableAction(
                    onPressed: (context) {
                      Get.to(UpdateData(userModles: UserModles(
                        ...
                        image: student[DataController.columnStudentImage],
                      ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        CircleAvatar(
                          radius: 50,
                          backgroundImage: student[DataController.columnStudentImage] != null &&
                              student[DataController.columnStudentImage].isNotEmpty
                              ? FileImage(File(student[DataController.columnStudentImage]))
